...
class ETL_data:
    ...
    def clean_zip(self, source_file):
        ...
        # zipcode.to_csv('zipcode_feather.csv')
        return zipcode
    ...
    def clean_cass(self, source_file, save_file, source_state='all', dest_zip='54942',
                   shipping_date_start='2018-10-01', shipping_window=7, truck_mode='LT', inbound_indicator='INBOUND'):
        """
        parameter:
...
def main_preprocess():
    ...
    print('Questions: how many steps to put elephant to a fridge')
    ...
    print('Answer: 3 steps-get an elephant, put it into fridge, close fridge :)')
    etld.cass_merge_zip(dfcass, zipcode, save_file=config.OUTPUT_CASSZIP_FILE)
